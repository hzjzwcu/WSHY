...
## [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson04.html#从输入url到页面展示)从输入URL到页面展示

知道了浏览器的几个主要进程的职责之后，那么接下来，我们就从浏览器的地址栏开始讲起。

### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson04.html#_1-用户输入)1. 用户输入
...
![img](./assets/fad33fc7c5f2bdf4e20cac7691484130.png)

从图中可以看出，当浏览器刚开始加载一个地址之后，标签页上的图标便进入了加载状态。但此时图中页面显示的依然是之前打开的页面内容，并没立即替换为极客时间的页面。因为需要等待提交文档阶段，页面内容才会被替换。

### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson04.html#_2-url请求过程)2. URL请求过程
...
![img](./assets/655cbf32dd4bb6f9decc5c7f9a535a7e.png)
...
![img](./assets/0c4987fe5d05646fa8245d8cc50d1a43.png)
...
![img](./assets/8951e161b5f44a73e52c16b631a63e1c.png)
...
![img](./assets/595902748d7d4c2f9c1d4783962ae43b.png)
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson04.html#_3-准备渲染进程)3. 准备渲染进程
...
![img](./assets/d8fe2afbd8ea2d4a8d8cc4bb14c50f28.png)
...
![img](./assets/fba1dd05f0aeba93a5cb25f305971274.png)
...
### [#](https://blog.poetries.top/browser-working-principle/guide/part1/lesson04.html#_4-提交文档)4. 提交文档
...
![img](./assets/a1b77a61361561e74e86fdae10ee246f.png)
