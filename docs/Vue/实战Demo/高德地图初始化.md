...
- 去高德开放平台[控制台](https://console.amap.com/dev/key/app)注册账号并进入**我的应用**界面
- 创建应用，添加 key ，保留生成的 key 和 安全密钥

### 2 引用依赖

- [安装](https://lbs.amap.com/api/jsapi-v2/guide/abc/load) `npm i @amap/amap-jsapi-loader --save`

### 3 初始化地图

- 详情参考[官网文档](https://lbs.amap.com/api/jsapi-v2/guide/abc/quickstart)

- 新建一个组合式函数用于初始化地图 `src/composables/map/useInitMap.js`，**注意替换 key**
...
- 详情参考[官网文档](https://lbs.amap.com/api/jsapi-v2/guide/services/geolocation)
